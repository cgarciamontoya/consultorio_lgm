...
public class CatEstadoCivil implements Serializable {
    private static final long serialVersionUID = -8327373665948651876L;
    @Id
    ...
    public CatEstadoCivil(Integer id) {
        this.id = id;
    }

    public CatEstadoCivil(Integer id, String descripcion) {
        this.id = id;
    ...
    public String toString() {
        return "consultorio.lgm.datos.entidades.CatEstadoCivil[ id=" + id + " ]";
    }
