 ...
 * @author cgarcia
 */
public class HistoriaClinicaReporte extends ReporteBase implements Reporte {
    ...
    public void generarReporte(List detalle, Map<String, Object> parametros, TipoReporte tipoReporte, OutputStream salida) {
        ...
        JasperPrint jasperPrint = llenarReporte(LGMConstantes.NOMBRE_REPORTE_HISTORIA_CLINICA,
